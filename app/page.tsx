  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)]">
      <div className="text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-4 font-press-start-2p">Your Name</h1>
        <h2 className="text-2xl md:text-3xl mb-8 text-blue-500 dark:text-blue-400">Gamer. Artist. Coder. Creator.</h2>
