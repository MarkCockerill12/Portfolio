...
import { Code, Gamepad, Palette, Music, Book, BookOpen } from 'lucide-react'
...
export default function About() {
  ...
  const hobbies = [
    ...
    },
    {
      icon: <Palette className="w-8 h-8 text-blue-500" />,
      title: "Animating",
      description: "I mainly use 3D software such as Blender, although I have created multiple 2D frame by frame animations. These require lots of patience and tie into creative skills in order to bring a visionto life. Problem solving skills are crucial as things never go as intended." 
    },
    {
    ...
    <ScrollAnimation>
      <div className="flex flex-col items-center space-y-8">
        <div className="flex space-x-4">
          ...
          <TabButton id="hobbies" label="Hobbies" />
        </div>
