...
function getGuyImageAndSize(scenario: GuyScenario) {
  switch (scenario) {
    ...
    case GuyScenario.Hover:
      return { src: 'https://pub-699441ce0cfb40449cc458823a3f1ed2.r2.dev/portfolio/media/LilGuy/GuyFall.webp', width: 50, height: 116 };
    case GuyScenario.Run:
      return { src: 'https://pub-699441ce0cfb40449cc458823a3f1ed2.r2.dev/portfolio/media/LilGuy/GuyRun.webp', width: 80, height: 116 };
    ...
    default:
      ...
      return { src: 'https://pub-699441ce0cfb40449cc458823a3f1ed2.r2.dev/portfolio/media/LilGuy/GuyStand.webp', width: 50, height: 116 };
  }
}
